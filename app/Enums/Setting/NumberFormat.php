...
enum NumberFormat: string implements HasLabel
{
    ...
    {
        $commaDot       = mb_strpos($formattedNumber, '.') && mb_strpos($formattedNumber, ',');
        $dotComma       = mb_strpos($formattedNumber, ',') && mb_strpos($formattedNumber, '.');
        $indianGrouping = mb_strpos($formattedNumber, ',') && ! mb_strpos($formattedNumber, '.');
        $apostropheDot  = mb_strpos($formattedNumber, '\'') && mb_strpos($formattedNumber, '.');
        $spaceComma     = mb_strpos($formattedNumber, ' ') && mb_strpos($formattedNumber, ',');
        $spaceDot       = mb_strpos($formattedNumber, ' ') && mb_strpos($formattedNumber, '.');
